      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="text-gray-400 mt-2">
            Manage your requests, earnings, and profile
          </p>
        </div>
                      ...
                      <div className="space-y-2">
                        ...
                        {earnings.earnings.slice(0, 5).map((earning: any) => (
                          <div
                            ...
                            className="flex justify-between p-2 bg-gray-800/50 rounded border border-gray-700"
                          >
                            <div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-yellow-300/80 mt-1">
                        Your KYC documents are under review. This usually takes
                        24-48 hours.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-300/80 mt-1">
                        Your identity has been verified. You can now accept
                        tasks.
                      </p>
                    </div>
                  </div>
